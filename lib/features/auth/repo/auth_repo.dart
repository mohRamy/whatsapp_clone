...
import 'package:whatsapp_getx/common/repositories/common_firebase_storage_repository.dart';
    ...
    try {
      await auth.verifyPhoneNumber(
        ...
        codeSent: ((String verificationId, int? resendToken) {
          ...
          //   (route) => false,
          // );
          Components.navigateAndFinish(context, Routes.otpScreen, {
            AppString.argumentVerificationId : verificationId,
            AppString.argumentPhoneNumber : phoneNumber,
          });
        }),
